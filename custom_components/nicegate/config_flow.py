...
class NiceOptionsFlow(config_entries.OptionsFlow):
    """Options for Nice gate."""
    ...
    async def async_step_init(
        ...
        current = self.config_entry.options.get(
            CONF_RELOAD_INTERVAL, DEFAULT_RELOAD_INTERVAL
        )
        schema = vol.Schema(
            {
                vol.Required(CONF_RELOAD_INTERVAL, default=current): vol.All(
